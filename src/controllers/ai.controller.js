...
exports.suggestCoreProject = async (req, res) => {
  try {
    ...
    const system = [
      ...
      '- CRITICAL KPI REQUIREMENT: Every KPI MUST contain a specific number, percentage, or dollar amount to be measurable. NEVER use vague phrases like "client participation" or "improve customer satisfaction" without a quantifiable target. Examples of GOOD KPIs: "Onboard 100 new users", "90% client participation", "Reduce costs by $10K", "Achieve 85% satisfaction score", "Generate 50 leads per month". Examples of BAD KPIs: "Improve engagement", "Better customer service", "Increase sales". Every KPI must have a concrete number.',
